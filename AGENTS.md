...
| --- | --- | --- |
| Android | v3.9-beta.8 (versionCode 65) | Play **Beta** (Open Testing) — also internal + closed; new Baloo Chettan 2 **വരി** wordmark launcher + solid-disc / hollow-വ notification icon, generated by the hora-core unified icon engine |
