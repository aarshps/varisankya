...
/**
 * Single source of truth for Chip styling and shape logic across the Hora family.
 */
object ChipHelper {

    /**
     * Applies standard Hora-family styling to a chip, including the dynamic shape
